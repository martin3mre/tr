...
<table>
    <thead>
        <tr>
            <th style="width: 100px; text-align:left;">Orijinal Makine</th>
...
<img src="https://github.com/martin3mre/martin3mre/blob/main/assets/images/Mars-Agent-Passphase-Key-Vault.png?raw=true" width="45%" height="45%" />
